...
interface EnhancedCodeHighlighterProps {
  code: string;
  language: string;
...
interface LineHighlight {
  lineNumber: number;
  type: 'annotation' | 'selection' | 'user-highlight' | 'focused' | 'search';
  color: string;
  opacity?: number;
  userId?: string;
}
...
export const EnhancedCodeHighlighter: React.FC<EnhancedCodeHighlighterProps> = ({
  code,
  language,
  annotations,
  selectedRange,
  ...
  }, [selectionState, readOnly, enableMultiSelection, onSelectionChange]);
